<script lang="ts">
	...
	const { size }: SocialLinksProps = $props();
</script>

<!-- style={{ width: smallSize ? '1.5rem' : '2.5rem', height: smallSize ? '1.5rem' : '2.5rem' }} -->

<div class="flex items-center justify-evenly gap-5 xl:justify-start">
	<a
	...
	>
		<svg
			class="fill-white transition-colors duration-300 hover:fill-slate-300"
			viewBox="0 0 16 16"
			style="
	...
	<a
		...
		style="
			...
			"
	>
		<svg class="fill-white transition-colors duration-300 hover:fill-slate-300" viewBox="0 0 16 16">
			>
			<path
